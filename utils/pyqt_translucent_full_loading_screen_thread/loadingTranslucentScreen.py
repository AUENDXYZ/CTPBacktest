...
from PySide6.QtWidgets import QWidget, QLabel, QGridLayout, QGraphicsOpacityEffect
from PySide6.QtCore import QSize, Qt, QThread, QTimer
from PySide6.QtGui import QMovie, QPalette, QColor
...
class LoadingTranslucentScreen(QWidget):
    ...
    def start(self):
        ...
        opacity_effect = QGraphicsOpacityEffect(opacity=0.15)
